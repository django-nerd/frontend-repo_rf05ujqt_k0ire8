    ...
    <section className="relative w-full h-[95vh] overflow-hidden">
      ...
      <div className="absolute inset-0" aria-hidden>
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          ...
          <div className="absolute -inset-20 bg-gradient-to-b from-black/30 via-transparent to-black/90" />
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-center md:text-left">
            <motion.h1
              ...
              <span className="block mt-3 text-zinc-100">— Bearing Worlds of Design</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="mt-6 text-zinc-300 text-lg md:text-xl max-w-xl">
              Myth meets machine. A portfolio forged with motion, light, and intention.
            </motion.p>
          ...
          <div className="relative">
            ...
            <AtlasFigure className="w-full h-[420px] md:h-[520px]" />
          </div>
        </div>
      </div>
    </section>
